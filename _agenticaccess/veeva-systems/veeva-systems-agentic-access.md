...
notable_actions: []
operation_count: 12
overview: 'Veeva Systems exposes 12 API operations that an AI agent could call, of which 7 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: veeva-systems-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/veeva-systems/refs/heads/main/agentic-access/veeva-systems-agentic-access.yml
