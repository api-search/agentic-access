...
operation_count: 14
overview: 'Mercado Pago exposes 14 API operations that an AI agent could call, of which 7 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: mercadopago-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/mercadopago/refs/heads/main/agentic-access/mercadopago-agentic-access.yml
