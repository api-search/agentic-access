...
- action_class: acting
  ...
  human_in_the_loop: required
  method: DELETE
  path: /v1/applications/{applicationId}/domains/{domainId}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
  path: /v1/applications/{applicationId}/keys/{keyId}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
  path: /v1/applications/{applicationId}/webhooks/{endpointId}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
  path: /v1/previews/{previewId}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
  path: /v1/publish-grants/{grantId}
- action_class: acting
