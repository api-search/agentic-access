...
- action_class: acting
  ...
  method: DELETE
  path: /accounts/{accountId}/api-keys/{keyId}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
...
- action_class: acting
  ...
  path: /orders/{orderId}
operation_count: 43
overview: 'Vantor exposes 43 API operations that an AI agent could call, of which 18 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 25 read, 13 write, 3 physical, and 2 safety-critical.
...
source_filename: maxar-technologies-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/vantor/refs/heads/main/agentic-access/maxar-technologies-agentic-access.yml
