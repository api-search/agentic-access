...
- action_class: acting
  ...
  path: /organizations/{orgName}/controlplanes/{cpName}
operation_count: 23
overview: 'Upbound exposes 23 API operations that an AI agent could call, of which 13 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 10 read, 10 write, and 3 safety-critical.
...
source_filename: upbound-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/upbound/refs/heads/main/agentic-access/upbound-agentic-access.yml
