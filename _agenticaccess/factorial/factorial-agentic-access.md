...
- action_class: acting
  ...
  method: POST
  path: /resources/employees/employees/{id}/terminate
operation_count: 30
overview: 'Factorial exposes 30 API operations that an AI agent could call, of which 18 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 12 read, 17 write, and 1 safety-critical.
...
source_filename: factorial-agentic-access.yml
