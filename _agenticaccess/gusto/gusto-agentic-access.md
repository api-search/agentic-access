...
- action_class: acting
  ...
  method: DELETE
  path: /v1/companies/{company_id}/bank-accounts/{bank_account_id}
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PUT
  path: /v1/companies/{company_id}/bank-accounts/verify
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
