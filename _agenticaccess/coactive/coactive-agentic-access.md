...
source_filename: coactive-agentic-access.yml
...
source_yaml: "generated: '2026-07-18'\nmethod: generated\nsource: openapi/coactive-openapi-original.json\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 118\n  by_action_class:\n    acting: 71\n    connected: 47\n  by_consequence:\n    write: 70\n    read: 47\n    safety-critical: 1\n  human_in_the_loop_required: 1\noperations:\n- path: /api/v0/chat\n  method: post\n  operationId: chat\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/v0/chat/dataset/{dataset_id}\n  method: post\n  operationId: chat-dataset\n  x-agentic-access:\n\
  ...
  \    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/v1/auth-management/users/{user_id}/roles\n  method: put\n  operationId: update-user-roles\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/v0/video-narrative-metadata/metadata\n  method: post\n  operationId: create-metadata-api-v-0-video-narrative-metadata-metadata-post\n  x-agentic-access:\n    action-class: a\n\n# --- truncated at 32 KB (40 KB total) ---\n# Full source: https://raw.githubusercontent.com/api-evangelist/coactive/refs/heads/main/agentic-access/coactive-agentic-access.yml\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/coactive/refs/heads/main/agentic-access/coactive-agentic-access.yml
