...
notable_actions: []
operation_count: 10
overview: 'KVdb exposes 10 API operations that an AI agent could call, of which 7 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: kvdb-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/kvdb/refs/heads/main/agentic-access/kvdb-agentic-access.yml
