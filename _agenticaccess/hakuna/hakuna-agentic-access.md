...
- action_class: acting
  ...
  path: /timer
operation_count: 33
overview: 'Hakuna exposes 33 API operations that an AI agent could call, of which 15 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 18 read, 14 write, and 1 safety-critical.
...
source_filename: hakuna-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/hakuna/refs/heads/main/agentic-access/hakuna-agentic-access.yml
