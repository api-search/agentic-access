...
method: generated
name: Regulatory Agentic Access
name_suffix: Agentic Access
notable_actions: []
operation_count: 7
overview: 'Regulatory exposes 7 API operations that an AI agent could call, of which 1 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
slug: regulatory-agentic-access
source_filename: regulatory-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/regulatory/refs/heads/main/agentic-access/regulatory-agentic-access.yml
