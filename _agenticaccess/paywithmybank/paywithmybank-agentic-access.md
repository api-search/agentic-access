...
operation_count: 31
overview: 'PayWithMyBank (Trustly) exposes 31 API operations that an AI agent could call, of which 15 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: paywithmybank-agentic-access.yml
...
source_yaml: "generated: '2026-07-20'\nmethod: generated\nsource: openapi/paywithmybank-openapi-original.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 31\n  by_action_class:\n    connected: 16\n    acting: 15\n  by_consequence:\n    read: 16\n    write: 13\n    physical: 2\n  human_in_the_loop_required: 0\noperations:\n- path: /transactions/{transactionId}/accountSummary\n  method: get\n  operationId: get-transaction-account-summary\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /transactions/{transactionId}/payment/paymentProvider/account/balance\n  method: get\n  operationId: get-transactions-account-balance\n  x-agentic-access:\n    action-class:\
  ...
  \ optional\n    token:\n      max-ttl: 3600\n    audit: none\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/paywithmybank/refs/heads/main/agentic-access/paywithmybank-agentic-access.yml
