...
- action_class: acting
  ...
  path: /orders/{id}
operation_count: 28
overview: 'Rentle exposes 28 API operations that an AI agent could call, of which 7 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 21 read, 5 write, and 2 physical.
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/rentle/refs/heads/main/agentic-access/rentle-agentic-access.yml
