...
- action_class: acting
  ...
  human_in_the_loop: required
  method: POST
  path: /api/v2/databases/{database}/database-roles/{name}/future-grants:revoke
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
  path: /api/v2/databases/{database}/database-roles/{name}/grants:revoke
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
...
source_filename: snowflake-agentic-access.yml
source_heading: Agentic Access
source_url: ''
source_yaml: "generated: '2026-07-15'\nmethod: generated\nsource: openapi/account.yaml, openapi/alert.yaml, openapi/api-integration.yaml, openapi/catalog-integration.yaml,\n  openapi/compute-pool.yaml, openapi/cortex-analyst.yaml, openapi/cortex-inference.yaml, openapi/cortex-search-service.yaml,\n  openapi/database-role.yaml, openapi/database.yaml, openapi/dynamic-table.yaml, openapi/event-table.yaml,\n  openapi/external-volume.yaml, openapi/function.yaml, openapi/grant.yaml, openapi/iceberg-table.yaml,\n  openapi/image-repository.yaml, openapi/managed-account.yaml, openapi/network-policy.yaml,\n  openapi/notebook.yaml, openapi/notification-integration.yaml, openapi/pipe.yaml, openapi/procedure.yaml,\n  openapi/result.yaml, openapi/role.yaml, openapi/schema.yaml, openapi/service.yaml, openapi/snowflake-sql-rest-api.yaml,\n  openapi/sqlapi.yaml, openapi/stage.yaml, openapi/stream.yaml, openapi/table.yaml, openapi/task.yaml,\n  openapi/user-defined-function.yaml, openapi/user.yaml, openapi/view.yaml,\
  ...
  \ at 32 KB (87 KB total) ---\n# Full source: https://raw.githubusercontent.com/api-evangelist/snowflake/refs/heads/main/agentic-access/snowflake-agentic-access.yml\n"
