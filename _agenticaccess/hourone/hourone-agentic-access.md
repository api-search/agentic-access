...
- action_class: acting
  ...
  path: /keys/{key_id}
operation_count: 26
overview: 'Hourone exposes 26 API operations that an AI agent could call, of which 15 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: hourone-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/hourone/refs/heads/main/agentic-access/hourone-agentic-access.yml
