...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: PUT
  path: /api/v3/purchase-orders/{procurify_PO}/
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /api/v3/purchase-orders/{procurify_PO}/reopen/
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_filename: procurify-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/procurify/refs/heads/main/agentic-access/procurify-agentic-access.yml
