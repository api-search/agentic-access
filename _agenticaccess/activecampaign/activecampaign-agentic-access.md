...
- action_class: acting
  ...
  method: PUT
  path: /api/crm-sync/v1/pipelines/{pipeline_id}/sync
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: PUT
...
- action_class: acting
  ...
  method: POST
  path: /channel/whatsapp/channels/whatsapp/template/{id}/send
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
