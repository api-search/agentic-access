...
- action_class: acting
  ...
  method: POST
  path: /bundle/callback/{entitlementType}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: PATCH
...
- action_class: acting
  ...
  human_in_the_loop: required
  method: POST
  path: /service/callback/{countryCode}/{consumer}/{requestType}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
...
- action_class: acting
  ...
  method: POST
  path: /adviceReconcile/{merchantId}
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /customers/{customerId}/score/creditinfo
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /customers/{id}/plans/provision
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_filename: mtn-group-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/mtn-group/refs/heads/main/agentic-access/mtn-group-agentic-access.yml
