...
- action_class: acting
  ...
  method: POST
  path: /invoices/{invoiceId}/reset-time
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
...
source_filename: everhour-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/everhour/refs/heads/main/agentic-access/everhour-agentic-access.yml
