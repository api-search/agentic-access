...
- action_class: acting
  ...
  human_in_the_loop: required
  method: POST
  path: /v1/orders/external-identifier/{external_id}/undispatch
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
  path: /v1/orders/{order_id}/undispatch
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
...
source_filename: nash-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/nash/refs/heads/main/agentic-access/nash-agentic-access.yml
