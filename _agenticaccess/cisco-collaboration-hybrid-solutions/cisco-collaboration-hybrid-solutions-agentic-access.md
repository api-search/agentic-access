...
- action_class: acting
  ...
  path: /memberships/{membershipId}
operation_count: 25
overview: 'Cisco Collaboration Hybrid Solutions exposes 25 API operations that an AI agent could call, of which 14 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 11 read, 11 write, and 3 physical.
...
source_filename: cisco-collaboration-hybrid-solutions-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/cisco-collaboration-hybrid-solutions/refs/heads/main/agentic-access/cisco-collaboration-hybrid-solutions-agentic-access.yml
