...
- action_class: acting
  ...
  path: /api/v1/observe/model-costs/{model_id}/
operation_count: 12
overview: 'Waxell exposes 12 API operations that an AI agent could call, of which 10 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 2 read, 8 write, and 2 safety-critical.
...
source_filename: waxell-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/waxell/refs/heads/main/agentic-access/waxell-agentic-access.yml
