...
operation_count: 32
overview: 'Ava Protocol exposes 32 API operations that an AI agent could call, of which 16 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 16 read, 15 write, and 1 physical.
...
source_filename: ava-protocol-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/ava-protocol/refs/heads/main/agentic-access/ava-protocol-agentic-access.yml
