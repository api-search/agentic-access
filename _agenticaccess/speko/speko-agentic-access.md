...
- action_class: acting
  ...
  method: POST
  path: /v1/callbacks/{id}/dispatch
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v1/calls/{id}/transfers/blind
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v1/calls/{id}/transfers/warm
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v1/calls/{id}/transfers/{transferId}/cancel
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v1/calls/{id}/transfers/{transferId}/complete
operation_count: 40
overview: 'Speko exposes 40 API operations that an AI agent could call, of which 22 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 18 read, 17 write, 4 physical, and 1 safety-critical.
...
source_filename: speko-agentic-access.yml
