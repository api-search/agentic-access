...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /account/client-accounts/auto-balance-transfer/cancel
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /account/client-accounts/wallets/transfer
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
operation_count: 404
overview: 'VoPay exposes 404 API operations that an AI agent could call, of which 258 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: vopay-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/vopay/refs/heads/main/agentic-access/vopay-agentic-access.yml
