...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /v4/orders/{id}/cancel
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v4/orders/{id}/finalize
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v4/orders/{id}/open
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v4/orders/{id}/partial-cancel
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /v4/orders/{orderId}/adjustments
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /v4/simulation/approve-order
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v4/simulation/payment-methods/bank-account
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v4/simulation/payment-methods/card
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_filename: slope-agentic-access.yml
...
source_yaml: "generated: '2026-07-21'\nmethod: generated\nsource: openapi/slope-v4-openapi.json\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 40\n  by_action_class:\n    acting: 25\n    connected: 15\n  by_consequence:\n    write: 11\n    read: 15\n    physical: 14\n  human_in_the_loop_required: 0\noperations:\n- path: /v4/auth/session\n  method: post\n  operationId: createAuthSession\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /v4/auth/token\n  method: post\n  operationId: createAuthToken\n  x-agentic-access:\n   \
  ...
  \      purpose-required: true\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /v4/orders/{id}/partial-cancel\n  method: post\n  operationId: partialCancelOrder\n  x-agentic-access:\n    action-class: acting\n    consequence: physical\n    subject: required\n    audience: null\n    token:\n      max-ttl: 300\n      exchange: true\n      purpose-required: true\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /v4/orders/{id}/repay-estimate\n  method: get\n  operationId: getOrderRepayEstimate\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /v4/orders/{id}/repay-full\n  method: post\n  operationId: repayOrderFull\n  x-agentic-access:\n    action-class: acting\n    consequence: physical\n    subject: required\n\
  \    audience: null\n    token:\n      max-ttl: 300\n      exchange: true\n      purpose-required: true\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /v4/orders/{orderId}/adjustments\n  method: post\n  operationId: createOrderAdjustment\n  x-agentic-access:\n    action-class: acting\n    consequence: physical\n    subject: required\n    audience: null\n    token:\n      max-ttl: 300\n      exchange: true\n      purpose-required: true\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /v4/orders/{orderId}/adjustments/{id}\n  method: get\n  operationId: getOrderAdjustment\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /v4/orders/{orderId}/items\n  method: get\n  operationId: listOrderItems\n  x-agentic-access:\n\
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/slope/refs/heads/main/agentic-access/slope-agentic-access.yml
