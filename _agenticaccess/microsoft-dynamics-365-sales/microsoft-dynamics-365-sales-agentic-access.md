...
- action_class: acting
  ...
  path: /salesorders
operation_count: 31
overview: 'Microsoft Dynamics 365 Sales exposes 31 API operations that an AI agent could call, of which 18 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 13 read, 16 write, and 2 physical.
...
source_filename: microsoft-dynamics-365-sales-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/microsoft-dynamics-365-sales/refs/heads/main/agentic-access/microsoft-dynamics-365-sales-agentic-access.yml
