...
operation_count: 18
overview: 'Microsoft 365 exposes 18 API operations that an AI agent could call, of which 5 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 13 read, 4 write, and 1 physical.
...
source_filename: microsoft-365-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/microsoft-365/refs/heads/main/agentic-access/microsoft-365-agentic-access.yml
