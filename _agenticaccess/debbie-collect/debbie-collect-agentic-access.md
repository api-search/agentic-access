...
- action_class: acting
  ...
  method: POST
  path: /cases/{caseId}/payments
operation_count: 23
overview: 'Debbie Collect exposes 23 API operations that an AI agent could call, of which 13 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 10 read, 12 write, and 1 physical.
...
source_filename: debbie-collect-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/debbie-collect/refs/heads/main/agentic-access/debbie-collect-agentic-access.yml
