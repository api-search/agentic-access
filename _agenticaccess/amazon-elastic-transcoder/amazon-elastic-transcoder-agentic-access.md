...
operation_count: 17
overview: 'Amazon Elastic Transcoder exposes 17 API operations that an AI agent could call, of which 10 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 7 read, 8 write, and 2 safety-critical.
...
source_filename: amazon-elastic-transcoder-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/amazon-elastic-transcoder/refs/heads/main/agentic-access/amazon-elastic-transcoder-agentic-access.yml
