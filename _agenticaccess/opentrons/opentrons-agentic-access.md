...
- action_class: acting
  ...
  path: /system/time
operation_count: 29
overview: 'Opentrons exposes 29 API operations that an AI agent could call, of which 12 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 17 read, 9 write, and 3 safety-critical.
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/opentrons/refs/heads/main/agentic-access/opentrons-agentic-access.yml
