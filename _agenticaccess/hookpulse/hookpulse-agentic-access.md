...
- action_class: acting
  ...
  path: /in/{id}
operation_count: 31
overview: 'HookPulse exposes 31 API operations that an AI agent could call, of which 14 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 17 read, 10 write, 2 physical, and 2 safety-critical.
...
source_filename: hookpulse-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/hookpulse/refs/heads/main/agentic-access/hookpulse-agentic-access.yml
