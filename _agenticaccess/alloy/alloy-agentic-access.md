...
method: generated
name: Alloy Agentic Access
name_suffix: Agentic Access
notable_actions: []
operation_count: 30
overview: 'Alloy exposes 30 API operations that an AI agent could call, of which 16 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
provider_name: Alloy
provider_slug: alloy
slug: alloy-agentic-access
source_filename: alloy-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/alloy/refs/heads/main/agentic-access/alloy-agentic-access.yml
