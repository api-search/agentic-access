...
- action_class: acting
  ...
  method: POST
  path: /NPPPAYMENTSTATUSWEBHOOK_TARGET_URL
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /PAYTORECEIVEPAYMENTWEBHOOK_TARGET_URL
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /RECEIVENPPPAYMENTRETURNWEBHOOK_TARGET_URL
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /RECEIVEPAYMENTWEBHOOK_TARGET_URL
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /Webhook_Payment_Instruction_Status_URL
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /au/payto/pam-v1/PaymentAgreement
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /au/payto/pam-v1/PaymentAgreementAsync
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
  path: /au/payto/pam-v1/PaymentAgreementAsync/{PaymentAgreementUID}/recall/{actionIdentification}
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
  path: /au/payto/pam-v1/PaymentAgreementAsync/{paymentAgreementUID}/bilateral
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
  path: /au/payto/pam-v1/PaymentAgreementAsync/{paymentAgreementUID}/status
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
  path: /au/payto/pam-v1/PaymentAgreementAsync/{paymentAgreementUID}/unilateral
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
  path: /au/payto/pam-v1/paymentAgreement/{PaymentAgreementUID}/recall/{actionIdentification}
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
  path: /au/payto/pam-v1/paymentagreement/{paymentAgreementUID}/bilateral
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
  path: /au/payto/pam-v1/paymentagreement/{paymentAgreementUID}/status
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
  path: /au/payto/pam-v1/paymentagreement/{paymentAgreementUID}/unilateral
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /au/payto/pas-v1/PaymentInstructionAsync
operation_count: 150
overview: 'Monoova exposes 150 API operations that an AI agent could call, of which 88 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: monoova-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/monoova/refs/heads/main/agentic-access/monoova-agentic-access.yml
