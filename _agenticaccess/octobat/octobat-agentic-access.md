...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /invoices/csv_export
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /invoices/pdf_export
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: PATCH
  path: /invoices/{id}/cancel_and_replace
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
...
source_filename: octobat-agentic-access.yml
