...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /place_connect_account_order
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
