...
- action_class: acting
  ...
  path: /payments
operation_count: 34
overview: 'Toro exposes 34 API operations that an AI agent could call, of which 13 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 21 read, 9 write, 3 physical, and 1 safety-critical.
...
source_filename: toro-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/toro/refs/heads/main/agentic-access/toro-agentic-access.yml
