...
notable_actions: []
operation_count: 23
overview: 'Giphy exposes 23 API operations that an AI agent could call, of which 2 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 21 read and 2 write.
...
source_filename: giphy-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/giphy/refs/heads/main/agentic-access/giphy-agentic-access.yml
