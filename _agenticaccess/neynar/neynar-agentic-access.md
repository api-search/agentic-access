...
- action_class: acting
  ...
  method: POST
  path: /v2/studio/deployment/stop
- action_class: acting
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /v2/studio/deployment/database/sql
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: DELETE
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /v2/studio/deployment/recover
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: DELETE
  path: /v2/studio/deployment/secrets/
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /v2/studio/deployment/session/cancel
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v2/studio/deployment/start
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v2/studio/deployment/upload-image
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v2/studio/deployment/upload-image-url
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v2/studio/vercel/
operation_count: 200
overview: 'Neynar exposes 200 API operations that an AI agent could call, of which 71 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: neynar-agentic-access.yml
...
source_yaml: "generated: '2026-07-15'\nmethod: generated\nsource: openapi/neynar-farcaster-api.yaml, openapi/neynar-hub-api.yaml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 200\n  by_action_class:\n    connected: 129\n    acting: 71\n  by_consequence:\n    read: 129\n    write: 45\n    physical: 25\n    safety-critical: 1\n  human_in_the_loop_required: 1\noperations:\n- path: /portal/organization/billing\n  method: get\n  operationId: billing\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /portal/subscription/upgrade\n  method: post\n  operationId: upgrade\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n\
  ...
  \  method: get\n  operationId: fetch-subscriptions-for-\n\n# --- truncated at 32 KB (54 KB total) ---\n# Full source: https://raw.githubusercontent.com/api-evangelist/neynar/refs/heads/main/agentic-access/neynar-agentic-access.yml\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/neynar/refs/heads/main/agentic-access/neynar-agentic-access.yml
