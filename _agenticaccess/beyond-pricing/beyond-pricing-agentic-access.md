...
notable_actions: []
operation_count: 31
overview: 'Beyond Pricing exposes 31 API operations that an AI agent could call, of which 13 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: beyond-pricing-agentic-access.yml
...
source_yaml: "generated: '2026-07-18'\nmethod: generated\nsource: openapi/beyond-pricing-openapi-original.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 31\n  by_action_class:\n    connected: 18\n    acting: 13\n  by_consequence:\n    read: 18\n    write: 13\n  human_in_the_loop_required: 0\noperations:\n- path: /api/v1/compsets/\n  method: get\n  operationId: list_compsets\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    scope:\n    - compsets:read\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /api/v1/compsets/{compset_id}/\n  method: get\n  operationId: get_compset\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    scope:\n    - compsets:read\n\
  ...
  \    audit: required\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/beyond-pricing/refs/heads/main/agentic-access/beyond-pricing-agentic-access.yml
