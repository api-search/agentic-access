...
- action_class: acting
  ...
  method: PUT
  path: /order/certificate/{orderId}/revoke
- action_class: acting
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /order/certificate/{orderId}/note
operation_count: 19
overview: 'Digicert exposes 19 API operations that an AI agent could call, of which 9 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 10 read, 6 write, 2 physical, and 1 safety-critical.
