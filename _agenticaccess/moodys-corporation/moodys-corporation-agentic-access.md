...
- action_class: acting
  ...
  path: /orders
operation_count: 24
overview: 'Moody''s Corporation exposes 24 API operations that an AI agent could call, of which 8 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 16 read, 7 write, and 1 physical.
...
source_filename: moodys-corporation-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/moodys-corporation/refs/heads/main/agentic-access/moodys-corporation-agentic-access.yml
