...
- action_class: acting
  ...
  human_in_the_loop: required
  method: DELETE
  path: /customers/invitations/{invitationId}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
...
- action_class: acting
  ...
  human_in_the_loop: required
  method: DELETE
  path: /parties/me/limits
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
  path: /party-invitations/{invitationId}
- action_class: acting
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /approvals/{approvalId}/deny
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /payment-requests/{paymentRequestId}/decline
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_filename: natural-ai-agentic-access.yml
...
source_yaml: "generated: '2026-07-20'\nmethod: generated\nsource: openapi/natural-ai-openapi-original.json\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 76\n  by_action_class:\n    acting: 43\n    connected: 33\n  by_consequence:\n    write: 26\n    read: 33\n    safety-critical: 6\n    physical: 11\n  human_in_the_loop_required: 6\noperations:\n- path: /agents\n  method: post\n  operationId: agents.create\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agents\n  method: get\n  operationId: agents.list\n  x-agentic-access:\n\
  ...
  \  method: get\n  operationId: parties.get\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /parties/me\n  method: patch\n  operationId: parties.update\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /parties/me/members\n  method: get\n  operationId: parties.listMembers\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /parties/{partyId}/compliance\n  method: get\n  operationId: parties.getCompliance\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n\
  - path: /parties/me/handle\n  method: put\n  operationId: parties.setHandle\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /parties/me/limits\n  method: get\n  operationId: parties.getLimits\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /parties/me/limits\n  method: put\n  operationId: parties.setLimits\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /parties/me/limits\n  method: delete\n  operationId: parties.disableLimits\n\
  \  x-agentic-access:\n    action-class: acting\n    consequence: safety-critical\n    subject: required\n    audience: null\n    token:\n      max-ttl: 120\n      exchange: true\n      purpose-required: true\n      proof-of-possession: true\n    escalation:\n      human-in-the-loop: required\n    audit: required\n- path: /parties/me/members/{userId}\n  method: delete\n  operationId: parties.removeMember\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /wallets\n  method: get\n  operationId: wallets.list\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /wallets\n  method: post\n  operationId: wallets.create\n  x-agentic-access:\n    action-class: acting\n\
  \    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /wallets/{walletId}\n  method: get\n  operationId: wallets.get\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /wallets/{walletId}\n  method: patch\n  operationId: wallets.update\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /wallets/{walletId}/default\n  method: post\n  operationId: wallets.setDefault\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n\
  \    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /wallets/{walletId}/freeze\n  method: post\n  operationId: wallets.freeze\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /wallets/{walletId}/unfreeze\n  method: post\n  operationId: wallets.unfreeze\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /wallets/{walletId}/agents\n  method: post\n  operationId: wallets.attachAgent\n  x-agentic-access:\n  \
  \  action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /wallets/{walletId}/agents\n  method: get\n  operationId: wallets.listAgents\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /wallets/{walletId}/agents/{agentId}/default\n  method: post\n  operationId: wallets.setAgentDefaultWallet\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /wallets/{walletId}/agents/{agentId}\n  method: delete\n  operationId: wallets.detachAgent\n  x-agentic-access:\n\
  \    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /external-accounts/processor-token\n  method: post\n  operationId: externalAccounts.createFromProcessorToken\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /external-accounts\n  method: get\n  operationId: externalAccounts.list\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /external-accounts/{externalAccountId}\n  method: get\n  operationId: externalAccounts.get\n  x-agentic-access:\n\
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/natural-ai/refs/heads/main/agentic-access/natural-ai-agentic-access.yml
