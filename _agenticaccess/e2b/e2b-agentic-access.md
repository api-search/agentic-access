...
- action_class: acting
  ...
  method: POST
  path: /sandboxes/{sandboxID}/processes/{processID}/signal
operation_count: 17
overview: 'E2B exposes 17 API operations that an AI agent could call, of which 9 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 8 read, 7 write, 1 physical, and 1 safety-critical.
...
source_filename: e2b-agentic-access.yml
