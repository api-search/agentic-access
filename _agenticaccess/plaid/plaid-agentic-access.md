...
operation_count: 265
overview: 'Plaid exposes 265 API operations that an AI agent could call, of which 265 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 180 write, 80 physical, and 5 safety-critical.
