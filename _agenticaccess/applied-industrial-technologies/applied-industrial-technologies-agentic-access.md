...
- action_class: acting
  ...
  path: /orders
operation_count: 4
overview: 'Applied Industrial Technologies exposes 4 API operations that an AI agent could call, of which 1 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: applied-industrial-technologies-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/applied-industrial-technologies/refs/heads/main/agentic-access/applied-industrial-technologies-agentic-access.yml
