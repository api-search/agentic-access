...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /api/v2/transactions/affirm
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /api/v2/transactions/mobilepay
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /api/v2/transactions/op-online-payment
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /api/v2/transactions/refund
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /api/v2/transactions/wallet
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /api/v2/transactions/{id}/capture
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /api/v2/transactions/{id}/extend
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /api/v2/transactions/{id}/issuer_instalment_selection
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /api/v2/transactions/{id}/refund
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /api/v2/transactions/{id}/release
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_yaml: "generated: '2026-07-15'\nmethod: generated\nsource: openapi/3ds-authentication-api.json, openapi/checkout-api.json, openapi/customer-api.json,\n  openapi/ecommerce-api.json, openapi/order-service-api.json, openapi/paypal-ecommerce-api.json,\n  openapi/reporting-api.json\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 78\n  by_action_class:\n    connected: 18\n    acting: 60\n  by_consequence:\n    read: 18\n    write: 33\n    physical: 27\n  human_in_the_loop_required: 0\noperations:\n- path: /v2/3d\n  method: get\n  operationId: getV23d\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /v2/lookup\n  method: post\n  operationId: postV2Lookup\n\
  ...
  \ max-ttl: 3600\n    audit: none\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/verifone/refs/heads/main/agentic-access/verifone-agentic-access.yml
