...
- action_class: acting
  ...
  human_in_the_loop: required
  method: POST
  path: /networks/{networkId}/appliance/warmSpare/swap
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
...
source_filename: cisco-meraki-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/cisco-meraki/refs/heads/main/agentic-access/cisco-meraki-agentic-access.yml
