...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /orders/{orderId}/assignuser
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_filename: shipstation-agentic-access.yml
