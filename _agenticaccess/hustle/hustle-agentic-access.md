...
notable_actions: []
operation_count: 23
overview: 'Hustle exposes 23 API operations that an AI agent could call, of which 14 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_url: ''
source_yaml: "generated: '2026-08-13'\nmethod: generated\nsource: openapi/hustle-access-token-api-openapi.yml, openapi/hustle-agents-api-openapi.yml,\n  openapi/hustle-custom-fields-api-openapi.yml, openapi/hustle-groups-api-openapi.yml, openapi/hustle-integrations-api-openapi.yml,\n  openapi/hustle-leads-api-openapi.yml, openapi/hustle-messages-api-openapi.yml, openapi/hustle-organizations-api-openapi.yml,\n  openapi/hustle-tags-api-openapi.yml, openapi/hustle-webhooks-api-openapi.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 23\n  by_action_class:\n    acting: 14\n    connected: 9\n  by_consequence:\n    write: 14\n    read: 9\n  human_in_the_loop_required: 0\noperations:\n- path: /oauth/token\n  method: post\n  x-agentic-access:\n    action-class:\
