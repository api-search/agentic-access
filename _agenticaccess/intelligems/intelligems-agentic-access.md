...
operation_count: 16
overview: 'Intelligems exposes 16 API operations that an AI agent could call, of which 13 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 3 read, 12 write, and 1 physical.
...
source_url: ''
source_yaml: "generated: '2026-08-13'\nmethod: generated\nsource: openapi/intelligems-analytics-api-openapi.yml, openapi/intelligems-custom-events-api-openapi.yml,\n  openapi/intelligems-experiences-api-openapi.yml, openapi/intelligems-holiday-benchmark-api-openapi.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 16\n  by_action_class:\n    connected: 3\n    acting: 13\n  by_consequence:\n    read: 3\n    write: 12\n    physical: 1\n  human_in_the_loop_required: 0\noperations:\n- path: /v25-10-beta/analytics/resource/{experienceId}\n  method: get\n  operationId: getExperienceAnalytics\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /v25-10-beta/analytics/resource/{experienceId}\n\
