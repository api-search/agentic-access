...
- action_class: acting
  ...
  method: POST
  path: /deposits/{currency}/address
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  path: /withdrawals
operation_count: 49
overview: 'Blockchain.com exposes 49 API operations that an AI agent could call, of which 5 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 44 read and 5 physical.
...
source_yaml: "generated: '2026-07-15'\nmethod: generated\nsource: openapi/blockchain-charts-stats-openapi.yml, openapi/blockchain-data-api-openapi.yml,\n  openapi/blockchain-exchange-openapi.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 49\n  by_action_class:\n    connected: 44\n    acting: 5\n  by_consequence:\n    read: 44\n    physical: 5\n  human_in_the_loop_required: 0\noperations:\n- path: /charts/{chartName}\n  method: get\n  operationId: getChart\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /stats\n  method: get\n  operationId: getStats\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n\
  ...
  \      max-ttl: 3600\n    audit: none\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/blockchain/refs/heads/main/agentic-access/blockchain-agentic-access.yml
