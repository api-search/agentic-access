...
operation_count: 27
overview: 'SignWell exposes 27 API operations that an AI agent could call, of which 14 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 13 read, 10 write, and 4 physical.
...
source_filename: signwell-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/signwell/refs/heads/main/agentic-access/signwell-agentic-access.yml
