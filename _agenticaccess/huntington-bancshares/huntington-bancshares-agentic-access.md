...
- action_class: acting
  ...
  path: /payments
operation_count: 4
overview: 'Huntington Bancshares exposes 4 API operations that an AI agent could call, of which 1 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: huntington-bancshares-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/huntington-bancshares/refs/heads/main/agentic-access/huntington-bancshares-agentic-access.yml
