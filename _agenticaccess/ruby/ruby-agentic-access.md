...
notable_actions: []
operation_count: 22
overview: 'Ruby Programming Language and Popular API Gems exposes 22 API operations that an AI agent could call, of which 8 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: ruby-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/ruby/refs/heads/main/agentic-access/ruby-agentic-access.yml
