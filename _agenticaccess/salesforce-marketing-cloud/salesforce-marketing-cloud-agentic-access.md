...
operation_count: 21
overview: 'Salesforce Marketing Cloud exposes 21 API operations that an AI agent could call, of which 14 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 7 read, 13 write, and 1 safety-critical.
...
source_filename: salesforce-marketing-cloud-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/salesforce-marketing-cloud/refs/heads/main/agentic-access/salesforce-marketing-cloud-agentic-access.yml
