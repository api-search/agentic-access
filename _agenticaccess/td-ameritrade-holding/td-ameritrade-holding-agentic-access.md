...
- action_class: acting
  ...
  path: /accounts/{accountId}/savedorders/{savedOrderId}
operation_count: 34
overview: 'TD Ameritrade Holding exposes 34 API operations that an AI agent could call, of which 11 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 23 read, 5 write, and 6 physical.
...
source_filename: td-ameritrade-holding-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/td-ameritrade-holding/refs/heads/main/agentic-access/td-ameritrade-holding-agentic-access.yml
