...
notable_actions: []
operation_count: 28
overview: 'Warp exposes 28 API operations that an AI agent could call, of which 12 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 16 read and 12 write.
...
source_filename: warp-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/warp/refs/heads/main/agentic-access/warp-agentic-access.yml
