...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /agent/action/send_event_preview
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /agent/action/send_rich_message_postback
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_yaml: "generated: '2026-09-16'\nmethod: generated\nsource: openapi/livechat-chats-api-openapi.yml, openapi/livechat-customers-api-openapi.yml,\n  openapi/livechat-events-api-openapi.yml, openapi/livechat-other-api-openapi.yml, openapi/livechat-properties-api-openapi.yml,\n  openapi/livechat-status-api-openapi.yml, openapi/livechat-threads-api-openapi.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 35\n  by_action_class:\n    acting: 35\n  by_consequence:\n    write: 28\n    physical: 7\n  human_in_the_loop_required: 0\noperations:\n- path: /agent/action/list_chats\n  method: post\n  operationId: listChats\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl:\
  ...
  \ conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/multicast\n  method: post\n  operationId: multicast\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/update_chat_properties\n  method: post\n  operationId: updateChatProperties\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/delete_chat_properties\n  method: post\n  operationId: deleteChatProperties\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject:\
  \ required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/update_thread_properties\n  method: post\n  operationId: updateThreadProperties\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/delete_thread_properties\n  method: post\n  operationId: deleteThreadProperties\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/update_event_properties\n\
  \  method: post\n  operationId: updateEventProperties\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/delete_event_properties\n  method: post\n  operationId: deleteEventProperties\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/set_routing_status\n  method: post\n  operationId: setRoutingStatus\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n\
  \      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/list_routing_statuses\n  method: post\n  operationId: listRoutingStatuses\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/list_threads\n  method: post\n  operationId: listThreads\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/tag_thread\n  method: post\n  operationId: tagThread\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n \
  \   token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/untag_thread\n  method: post\n  operationId: untagThread\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /agent/action/request_thread_summary\n  method: post\n  operationId: requestThreadSummary\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/livechat/refs/heads/main/agentic-access/livechat-agentic-access.yml
