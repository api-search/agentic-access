...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /payments/instant/{paymentId}/return
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_filename: montran-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/montran/refs/heads/main/agentic-access/montran-agentic-access.yml
