...
- action_class: acting
  ...
  path: /orders/{id}
operation_count: 22
overview: 'BlueCart exposes 22 API operations that an AI agent could call, of which 13 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 9 read, 10 write, 2 physical, and 1 safety-critical.
...
source_filename: bluecart-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/bluecart/refs/heads/main/agentic-access/bluecart-agentic-access.yml
