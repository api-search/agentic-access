...
- action_class: acting
  ...
  method: POST
  path: /rest/transact/xmlapi
operation_count: 17
overview: 'Silverpop exposes 17 API operations that an AI agent could call, of which 7 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 10 read, 6 write, and 1 physical.
...
source_filename: silverpop-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/silverpop/refs/heads/main/agentic-access/silverpop-agentic-access.yml
