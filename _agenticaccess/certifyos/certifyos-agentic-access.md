...
- action_class: acting
  ...
  human_in_the_loop: required
  method: PATCH
  path: /credentialing-workflows/{id}/notes/{noteId}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: PATCH
...
source_filename: certifyos-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/certifyos/refs/heads/main/agentic-access/certifyos-agentic-access.yml
