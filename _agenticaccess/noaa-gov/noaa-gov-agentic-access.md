...
notable_actions: []
operation_count: 66
overview: 'NOAA — National Oceanic and Atmospheric Administration exposes 66 API operations that an AI agent could call, of which 0 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 66 read.
...
source_filename: noaa-gov-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/noaa-gov/refs/heads/main/agentic-access/noaa-gov-agentic-access.yml
