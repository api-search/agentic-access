...
operation_count: 23
overview: 'Cognition AI exposes 23 API operations that an AI agent could call, of which 14 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 9 read, 11 write, 1 physical, and 2 safety-critical.
...
source_filename: cognition-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/cognition/refs/heads/main/agentic-access/cognition-agentic-access.yml
