...
notable_actions: []
operation_count: 154
overview: 'Oura exposes 154 API operations that an AI agent could call, of which 8 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 146 read and 8 write.
...
source_yaml: "generated: '2026-07-15'\nmethod: generated\nsource: openapi/oura-api-openapi.json, openapi/oura-api-openapi.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 154\n  by_action_class:\n    connected: 146\n    acting: 8\n  by_consequence:\n    read: 146\n    write: 8\n  human_in_the_loop_required: 0\noperations:\n- path: /v2/usercollection/personal_info\n  method: get\n  operationId: Single_Personal_Info_Document_v2_usercollection_personal_info_get\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /v2/usercollection/tag\n  method: get\n  operationId: Multiple_tag_Documents_v2_usercollection_tag_get\n  x-agentic-access:\n    action-class: connected\n\
  ...
  \  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /v2/sandbox/usercollection/daily_cardiovascular_age\n  method: get\n  operationId: Sandbox___Multiple_daily_cardiovascular_age_Documents_v2_sandbox_usercollection_daily_cardiovascular_age_get\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    au\n\n# --- truncated at 32 KB (46 KB total) ---\n# Full source: https://raw.githubusercontent.com/api-evangelist/oura-ring/refs/heads/main/agentic-access/oura-ring-agentic-access.yml\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/oura-ring/refs/heads/main/agentic-access/oura-ring-agentic-access.yml
