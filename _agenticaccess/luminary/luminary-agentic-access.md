...
notable_actions: []
operation_count: 31
overview: 'Luminary exposes 31 API operations that an AI agent could call, of which 12 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 19 read and 12 write.
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/luminary/refs/heads/main/agentic-access/luminary-agentic-access.yml
