...
- action_class: acting
  ...
  path: /v1/projects/{scriptId}/deployments/{deploymentId}
operation_count: 16
overview: 'Google Apps Script exposes 16 API operations that an AI agent could call, of which 7 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
...
source_filename: google-apps-script-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/google-apps-script/refs/heads/main/agentic-access/google-apps-script-agentic-access.yml
