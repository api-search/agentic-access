...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /api/inApp/target
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /api/push/target
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /api/templates/email/proof
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_url: ''
source_yaml: "generated: '2026-09-16'\nmethod: generated\nsource: openapi/iterable-campaigns-api-openapi.yml, openapi/iterable-catalogs-api-openapi.yml,\n  openapi/iterable-channels-api-openapi.yml, openapi/iterable-commerce-api-openapi.yml, openapi/iterable-email-api-openapi.yml,\n  openapi/iterable-embedded-messaging-api-openapi.yml, openapi/iterable-events-api-openapi.yml,\n  openapi/iterable-experiments-api-openapi.yml, openapi/iterable-export-api-openapi.yml, openapi/iterable-in-app-api-openapi.yml,\n  openapi/iterable-in-app-web-api-openapi.yml, openapi/iterable-lists-api-openapi.yml, openapi/iterable-message-types-api-openapi.yml,\n  openapi/iterable-metadata-api-openapi.yml, openapi/iterable-push-api-openapi.yml, openapi/iterable-sms-api-openapi.yml,\n  openapi/iterable-snippets-api-openapi.yml, openapi/iterable-subscriptions-api-openapi.yml,\n  openapi/iterable-templates-api-openapi.yml, openapi/iterable-users-api-openapi.yml, openapi/iterable-verify-api-openapi.yml,\n  openapi/iterable-web-push-api-openapi.yml,\
  \ openapi/iterable-webhooks-api-openapi.yml, openapi/iterable-whats-app-api-openapi.yml,\n  openapi/iterable-workflows-api-openapi.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 192\n  by_action_class:\n    connected: 71\n    acting: 121\n  by_consequence:\n    read: 71\n    write: 103\n    physical: 17\n    safety-critical: 1\n  human_in_the_loop_required: 1\noperations:\n- path: /api/campaigns\n  method: get\n  operationId: campaigns\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /api/campaigns/abort\n  method: post\n  operationId: abort campaign\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n\
  \    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/campaigns/activateTriggered\n  method: post\n  operationId: activate triggered campaign\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/campaigns/archive\n  method: post\n  operationId: archive campaigns\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/campaigns/cancel\n  method: post\n  operationId: cancel campaign\n\
  \  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/campaigns/create\n  method: post\n  operationId: create campaign\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/campaigns/deactivateTriggered\n  method: post\n  operationId: Deactivate triggered campaign\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n   \
  \ audit: required\n- path: /api/campaigns/metrics\n  method: get\n  operationId: metrics\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /api/campaigns/recurring/{id}/childCampaigns\n  method: get\n  operationId: child campaigns\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /api/campaigns/trigger\n  method: post\n  operationId: trigger campaign\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/campaigns/{campaignId}/schedule\n  method: post\n  operationId: schedule campaign\n  x-agentic-access:\n    action-class: acting\n    consequence:\
  ...
  \      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/email/cancel\n  method: post\n  operationId: cancel\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/email/target\n  method: post\n  operationId: target\n  x-agentic-access:\n    action-class: acting\n    consequence: physical\n    subject: required\n    audience: null\n    token:\n      max-ttl: 300\n      exchange: true\n      purpose-required: true\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/email/viewInBrowser\n  method: get\n  operationId: viewInBrowser\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n\
  ...
  \ conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/push/cancel\n  method: post\n  operationId: cancel\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /api/push/target\n  method: post\n  operationId: target\n  x-agentic-access:\n    action-class: acting\n    consequence: physical\n    subject: required\n    audience: null\n    token:\n      max-ttl: 300\n      exchange: true\n      purpose-required: true\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n\n\n# --- truncated at 32 KB (57 KB total) ---\n# Full source: https://raw.githubusercontent.com/api-evangelist/iterable/refs/heads/main/agentic-access/iterable-agentic-access.yml\n"
