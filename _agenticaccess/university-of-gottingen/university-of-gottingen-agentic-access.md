...
source_yaml: "generated: '2026-07-15'\nmethod: generated\nsource: openapi/university-of-gottingen-grodata-rest.yaml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 491\n  by_action_class:\n    connected: 260\n    acting: 231\n  by_consequence:\n    read: 260\n    write: 221\n    safety-critical: 7\n    physical: 3\n  human_in_the_loop_required: 7\noperations:\n- path: /access/datafile/bundle/{fileId}\n  method: get\n  operationId: Access_datafileBundle\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /access/datafile/{fileId}\n  method: get\n  operationId: Access_datafile\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject:\
  ...
  \    token:\n      max-ttl: 3600\n    audit: none\n- path: /admin/index/continue\n  method: get\n  operationId: Index_indexAllOrSubsetContinue\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /admin/index/dataset\n  method: get\n  operationId: Index_indexDatasetByPersistentId\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /admin/index/datasets/{id}\n  method: delete\n  operationId: Index_clearDatasetFromIndex\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /admin/index/filemetadata/{dataset_id}\n\n# --- truncated at 32 KB (143 KB total) ---\n\
  # Full source: https://raw.githubusercontent.com/api-evangelist/university-of-gottingen/refs/heads/main/agentic-access/university-of-gottingen-agentic-access.yml\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/university-of-gottingen/refs/heads/main/agentic-access/university-of-gottingen-agentic-access.yml
