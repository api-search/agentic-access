...
- action_class: acting
  ...
  method: POST
  path: /newsletters/send-draft
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /newsletters/{newsletterId}/cancel
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/getresponse/refs/heads/main/agentic-access/getresponse-agentic-access.yml
