...
overview: 'PageAudit exposes 38 API operations that an AI agent could call, of which 16 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.
  ...
  By consequence: 22 read, 14 write, 1 physical, and 1 safety-critical.
...
source_filename: pageaudit-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/pageaudit/refs/heads/main/agentic-access/pageaudit-agentic-access.yml
