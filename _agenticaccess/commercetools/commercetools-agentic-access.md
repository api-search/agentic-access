...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /{projectKey}/orders/import-containers/{importContainerKey}
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_filename: commercetools-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/commercetools/refs/heads/main/agentic-access/commercetools-agentic-access.yml
