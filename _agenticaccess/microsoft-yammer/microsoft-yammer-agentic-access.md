...
- action_class: acting
  ...
  path: /group_memberships.json
operation_count: 33
overview: 'Microsoft Yammer exposes 33 API operations that an AI agent could call, of which 12 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 21 read, 10 write, and 2 physical.
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/microsoft-yammer/refs/heads/main/agentic-access/microsoft-yammer-agentic-access.yml
