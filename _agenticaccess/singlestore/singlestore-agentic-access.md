...
- action_class: acting
  ...
  path: /stage/{deploymentID}/fs/{stagePath}
operation_count: 29
overview: 'SingleStore exposes 29 API operations that an AI agent could call, of which 16 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 13 read, 11 write, 3 physical, and 2 safety-critical.
...
source_filename: singlestore-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/singlestore/refs/heads/main/agentic-access/singlestore-agentic-access.yml
