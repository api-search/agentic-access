...
notable_actions: []
operation_count: 37
overview: 'Stack Overflow exposes 37 API operations that an AI agent could call, of which 8 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 29 read and 8 write.
...
source_filename: stack-overflow-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/stack-overflow/refs/heads/main/agentic-access/stack-overflow-agentic-access.yml
