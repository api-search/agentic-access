...
- action_class: acting
  ...
  path: /v4/ships/query
operation_count: 43
overview: 'SpaceX (Community API) exposes 43 API operations that an AI agent could call, of which 13 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 30 read, 12 write, and 1 physical.
...
source_filename: spacex-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/spacex/refs/heads/main/agentic-access/spacex-agentic-access.yml
