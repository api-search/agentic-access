...
source_yaml: "generated: '2026-07-15'\nmethod: generated\nsource: openapi/anrok-api-openapi.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 17\n  by_action_class:\n    acting: 17\n  by_consequence:\n    write: 17\n  human_in_the_loop_required: 0\noperations:\n- path: /v1/seller/certificates/create\n  method: post\n  operationId: certificatesCreate\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /v1/seller/certificates/id:{certificateId}/archive\n  method: post\n  operationId: certificatesArchive\n  x-agentic-access:\n\
  ...
  \      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /v1/seller/products/externalId:{externalId}/get\n  method: post\n  operationId: productsGet\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /v1/seller/productTaxCategories/list\n  method: post\n  operationId: productTaxCategoriesList\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/anrok/refs/heads/main/agentic-access/anrok-agentic-access.yml
