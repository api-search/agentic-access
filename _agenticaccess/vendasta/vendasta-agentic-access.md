...
- action_class: acting
  ...
  method: POST
  path: /v1/crm/opportunity/field-options
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
  path: /v1/crm/opportunity/list
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
  path: /orderCustomFields/{id}
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
  path: /orderFulfillmentForms/{id}
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /orderFulfillmentForms/{id}/actions/submit
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /users/{id}/relationships/businessLocations
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PATCH
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /v1/forms/provision-recaptcha-enterprise
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /v1/order/custom-fields/get
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v1/order/custom-fields/list
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_filename: vendasta-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/vendasta/refs/heads/main/agentic-access/vendasta-agentic-access.yml
