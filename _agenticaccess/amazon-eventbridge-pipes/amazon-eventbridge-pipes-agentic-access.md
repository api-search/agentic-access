...
operation_count: 10
overview: 'Amazon EventBridge Pipes exposes 10 API operations that an AI agent could call, of which 7 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 3 read, 6 write, and 1 safety-critical.
...
source_filename: amazon-eventbridge-pipes-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/amazon-eventbridge-pipes/refs/heads/main/agentic-access/amazon-eventbridge-pipes-agentic-access.yml
