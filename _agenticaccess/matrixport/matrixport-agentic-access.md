...
- action_class: acting
  ...
  method: POST
  path: /v1/amend_batchorders
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v1/amend_orders
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /v1/cancel_orders
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /v1/close_positions
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
