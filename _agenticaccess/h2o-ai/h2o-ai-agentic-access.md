...
- action_class: acting
  ...
  human_in_the_loop: required
  method: POST
  path: /ai_assistants/{assistant_id}/stop
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
  path: /ai_assistants/{assistant_id}/tool
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: required
  method: POST
  path: /messages/{question_id}/stop
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: PUT
  path: /prompt_templates/{prompt_template_id}/group_permissions
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: PUT
  path: /prompt_templates/{prompt_template_id}/permissions
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
  path: /user_jobs/{job_id}/cancel
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
  path: /users/{user_id}/configurations/{key_name}/reset
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
...
- action_class: acting
  ...
  method: POST
  path: /ai_assistants/{assistant_id}/messages
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /ai_assistants/{assistant_id}/send_to_assistant
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /messages/{question_id}/hitl
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /models/{model_name}/answer_question
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_filename: h2o-ai-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/h2o-ai/refs/heads/main/agentic-access/h2o-ai-agentic-access.yml
