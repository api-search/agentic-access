...
- action_class: acting
  ...
  method: POST
  path: /campaigns/{campaign_id}/test
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /subscribers/{subscriber_id}/optin
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_filename: listmonk-agentic-access.yml
