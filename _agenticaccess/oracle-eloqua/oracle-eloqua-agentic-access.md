...
operation_count: 19
overview: 'Oracle Eloqua exposes 19 API operations that an AI agent could call, of which 10 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 9 read, 9 write, and 1 physical.
...
source_filename: oracle-eloqua-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/oracle-eloqua/refs/heads/main/agentic-access/oracle-eloqua-agentic-access.yml
