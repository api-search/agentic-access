...
operation_count: 69
overview: 'FlightAware exposes 69 API operations that an AI agent could call, of which 6 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 63 read, 5 write, and 1 safety-critical.
...
source_yaml: "generated: '2026-09-10'\nmethod: generated\nsource: openapi/flightaware-account-api-openapi.yml, openapi/flightaware-airports-api-openapi.yml,\n  openapi/flightaware-alerts-api-openapi.yml, openapi/flightaware-flights-api-openapi.yml, openapi/flightaware-foresight-api-openapi.yml,\n  openapi/flightaware-history-api-openapi.yml, openapi/flightaware-miscellaneous-api-openapi.yml,\n  openapi/flightaware-operators-api-openapi.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 69\n  by_action_class:\n    connected: 63\n    acting: 6\n  by_consequence:\n    read: 63\n    write: 5\n    safety-critical: 1\n  human_in_the_loop_required: 1\noperations:\n- path: /account/usage\n  method: get\n  operationId: get_account_usage\n  x-agentic-access:\n   \
  ...
  \  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /airports/{id}/flights/arrivals/cancellations\n  method: get\n  operationId: get_airport_flights_arrivals_cancellations\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /airports/{id}/flights/departures\n  method: get\n  operationId: get_airport_flights_departed\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /airports/{id}/flights/departures/cancellations\n  method: get\n  operationId: get_airport_flights_departures_cancellations\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /airports/{id}/flights/scheduled_departures\n\
  ...
  \  method: get\n  operationId: get_history_flight_map\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /history/flights/{id}/route\n  method: get\n  operationId: get_history_flight_route\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /history/airports/{id}/flights/arrivals\n  method: get\n  operationId: get_history_airports_flights_arrived\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /history/airports/{id}/flights/arrivals/cancellations\n  method: get\n  operationId: get_history_airports_flights_arrivals_cancellations\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path:\
  \ /history/airports/{id}/flights/departures\n  method: get\n  operationId: get_history_airports_flights_departed\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /history/airports/{id}/flights/departures/cancellations\n  method: get\n  operationId: get_history_airports_flights_departures_cancellations\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /history/airports/{id}/flights/to/{dest_id}\n  method: get\n  operationId: get_history_flights_between_airports\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /history/aircraft/{registration}/last_flight\n  method: get\n  operationId: get_history_aircraft_last_flight\n  x-agentic-access:\n    action-class: connected\n    consequence:\
  \ read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /history/operators/{id}/flights\n  method: get\n  operationId: get_history_operators_flights\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /history/operators/{id}/flights/cancellations\n  method: get\n  operationId: get_history_operators_flights_cancellations\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /aircraft/{ident}/blocked\n  method: get\n  operationId: get_aircraft_blocked\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /aircraft/{ident}/owner\n  method: get\n  operationId: get_aircraft_owner\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject:\
