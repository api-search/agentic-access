...
- action_class: acting
  ...
  method: POST
  path: /{division}/purchaseorder/PurchaseOrders
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /{division}/salesinvoice/SalesInvoices
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: PUT
  path: /{division}/salesinvoice/SalesInvoices({id})
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: DELETE
...
- action_class: acting
  ...
  human_in_the_loop: conditional
  method: POST
  path: /{division}/salesorder/SalesOrders
operation_count: 26
overview: 'Exact Online exposes 26 API operations that an AI agent could call, of which 13 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 13 read, 8 write, and 5 physical.
...
source_yaml: "generated: '2026-07-15'\nmethod: generated\nsource: openapi/exact-online-openapi.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 26\n  by_action_class:\n    connected: 13\n    acting: 13\n  by_consequence:\n    read: 13\n    write: 8\n    physical: 5\n  human_in_the_loop_required: 0\noperations:\n- path: /current/Me\n  method: get\n  operationId: getCurrentMe\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /{division}/system/Divisions\n  method: get\n  operationId: listDivisions\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /{division}/system/AllDivisions\n\
  ...
  \  method: post\n  operationId: createPurchaseOrder\n  x-agentic-access:\n    action-class: acting\n    consequence: physical\n    subject: required\n    audience: null\n    token:\n      max-ttl: 300\n      exchange: true\n      purpose-required: true\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /{division}/financial/GLAccounts\n  method: get\n  operationId: listGLAccounts\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /{division}/financial/GLAccounts\n  method: post\n  operationId: createGLAccount\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /{division}/logistics/Items\n\
  \  method: get\n  operationId: listItems\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /{division}/logistics/Items\n  method: post\n  operationId: createItem\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/exact-online/refs/heads/main/agentic-access/exact-online-agentic-access.yml
