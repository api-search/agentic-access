...
overview: 'Cloudflare exposes 3118 API operations that an AI agent could call, of which 1576 are state-changing ''acting'' operations. This is a recommended x-agentic-access execution contract — the scope, audience, consequence tier, short-lived token constraints, and escalation each action should carry before it is handed to an autonomous agent.


  By consequence: 1542 read, 1476 write, 48 physical, and 52 safety-critical.
...
source_filename: cloudflare-agentic-access.yml
source_heading: Agentic Access
source_url: ''
source_yaml: "generated: '2026-07-15'\nmethod: generated\nsource: openapi/cloudflare-accounts--openapi-original.yml, openapi/cloudflare-ai-gateway-openapi.yml,\n  openapi/cloudflare-certificates--openapi-original.yml, openapi/cloudflare-d1-openapi.yml,\n  openapi/cloudflare-dns-openapi.yml, openapi/cloudflare-durable-objects-openapi.yml, openapi/cloudflare-hyperdrive-openapi.yml,\n  openapi/cloudflare-images-openapi.yml, openapi/cloudflare-ips--openapi-original.yml, openapi/cloudflare-kv-openapi.yml,\n  openapi/cloudflare-logpush-openapi.yml, openapi/cloudflare-memberships--openapi-original.yml,\n  openapi/cloudflare-openapi-original.yml, openapi/cloudflare-pages-openapi.yml, openapi/cloudflare-queues-openapi.yml,\n  openapi/cloudflare-r2-openapi.yml, openapi/cloudflare-radar--openapi-original.yml, openapi/cloudflare-stream-openapi.yml,\n  openapi/cloudflare-turnstile-openapi.yml, openapi/cloudflare-user--openapi-original.yml, openapi/cloudflare-vectorize-openapi.yml,\n  openapi/cloudflare-workers-ai-openapi.yml,\
  \ openapi/cloudflare-workers-openapi.yml, openapi/cloudflare-zones--openapi-original.yml\ndescription: Recommended x-agentic-access execution contracts, classified heuristically from\n  the OpenAPI. A governance starting point for exposing this API to AI agents — review and bind\n  audience per deployment. See research/curity/agentic-governance/.\nsummary:\n  operations: 3118\n  by_action_class:\n    connected: 1542\n    acting: 1576\n  by_consequence:\n    read: 1542\n    write: 1476\n    physical: 48\n    safety-critical: 52\n  human_in_the_loop_required: 52\noperations:\n- path: /accounts/{account_id}\n  method: get\n  operationId: accounts-account-details\n  x-agentic-access:\n    action-class: connected\n    consequence: read\n    subject: optional\n    token:\n      max-ttl: 3600\n    audit: none\n- path: /accounts/{account_id}\n  method: put\n  operationId: accounts-update-account\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n   \
  ...
  \  method: post\n  operationId: workers-ai-post-run-hf-thebloke-starling-lm-7b-alpha-awq\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    token:\n      max-ttl: 900\n    escalation:\n      human-in-the-loop: conditional\n      triggers:\n      - abnormal\n      - high-value\n    audit: required\n- path: /accounts/{account_id}/ai/run/@hf/thebloke/zephyr-7b-beta-awq\n  method: post\n  operationId: workers-ai-post-run-hf-thebloke-zephyr-7b-beta-awq\n  x-agentic-access:\n    action-class: acting\n    consequence: write\n    subject: required\n    audience: null\n    \n\n# --- truncated at 32 KB (1012 KB total) ---\n# Full source: https://raw.githubusercontent.com/api-evangelist/cloudflare/refs/heads/main/agentic-access/cloudflare-agentic-access.yml\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/cloudflare/refs/heads/main/agentic-access/cloudflare-agentic-access.yml
