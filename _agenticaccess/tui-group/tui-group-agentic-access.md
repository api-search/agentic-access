...
- action_class: acting
  ...
  human_in_the_loop: required
  method: POST
  path: /api/nsk/v1/booking/fareOverride/journey/{journeyKey}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: PUT
  path: /api/nsk/v1/booking/fee/{feeKey}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: PUT
  path: /api/nsk/v1/booking/fees
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
  path: /api/nsk/v1/booking/reset
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: PUT
  path: /api/nsk/v1/booking/salesChannel
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
  path: /api/nsk/v1/bookings/{recordLocator}/fareOverride/journey/{journeyKey}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
  path: /api/nsk/v1/persons/{personKey}
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: DELETE
  path: /api/nsk/v1/user/impersonate
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
  path: /api/nsk/v1/users/{userKey}/password/reset
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
...
- action_class: acting
  ...
  human_in_the_loop: required
  method: POST
  path: /api/nsk/v3/trip/move/availability
- action_class: acting
  consequence: safety-critical
  human_in_the_loop: required
  method: POST
...
- action_class: acting
  ...
  method: POST
  path: /api/dcs/v1/printers/receipts/payment/print
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /api/dcs/v1/printers/receipts/payment/printStreams
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /api/dcs/v1/printers/reports/paymentReceiptReport/printStreams
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
  path: /api/dcs/v1/printers/reports/transferBagTagReport/printStreams
- action_class: acting
  consequence: physical
  human_in_the_loop: conditional
  method: POST
...
source_filename: tui-group-agentic-access.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/tui-group/refs/heads/main/agentic-access/tui-group-agentic-access.yml
